...
def main(argv):
    with NeubiasJob.from_cli(argv) as nj:
        ...
        command = "/usr/bin/xvfb-run ./ImageJ-linux64 --ij2 --headless --console --run Trackmate_script.py" \
					"\"input={}, output={}, rad={}, thr={}, dst={}, gapdst={}, gap={}, minlgth={}\"".format(
            in_path, out_path, nj.parameters.rad, nj.parameters.thr, nj.parameters.dst, nj.parameters.gapdst, nj.parameters.gap, nj.parameters.minlgth)
